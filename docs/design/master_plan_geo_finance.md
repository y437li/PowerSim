...
7. **Finance-specific rulings — see finance-expert's §5.13 (10 decisions)** for the USER: the memo-vs-cash accounting ruling (§5.4 — degradation/curtail/VOLL memo-only, wear's cash impact via replacement-CAPEX), pre-tax/all-equity base case, WACC default+range, 10 & 20 yr, dual View I/II, ¥-nominal basis, and the **P50/P90/P99 ensemble target (v1 = M=1 point estimate, schema ready)**. These are the finance section's gate decisions; §9-1…6 are the plan-level ones.
